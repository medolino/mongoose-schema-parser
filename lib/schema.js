 ...
 *
 * @param  {Array}  path - Path to timestamp field, sepatared by dots
 ...
 *
 * @param  {Object} options - Mongoose timestamps options
...
/**
 * Parse data from schema options and manually generate specific fields, which are then added to parsed (_id and timestamps).
 * NOTE:
 * I am handling option fields this way, because I am parsing obj property, where this fields are not present.
 *
